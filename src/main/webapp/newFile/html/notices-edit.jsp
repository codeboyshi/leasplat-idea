			...
			<div id="container">
				<div class="ctx">
					<div class="search">
						<div class="group">
							<label>名称：</label>
							<input type="text" name="" id="name" value="${notices.noticeMessage }"/>
							<input type="hidden" name="id" id="id" value="${notices.id }">
						</div>
						<div class="btn-group">
 ...
 <script type="text/javascript">
	...
	$(function(){
		$("#update").click(function () {
			...
			$.post("../notice/update.do",{id:id,name:name},function(data){
				console.log(data)
