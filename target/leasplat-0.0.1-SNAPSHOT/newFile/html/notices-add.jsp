			...
			<div id="container">
				<div class="ctx">
					<div class="search">
						...
						<div class="btn-group">
							<div class="search-btn" id="update" style="background:blue;color:#FFF;">添加</div>
							<div class="search-btn" id="private-return" style="background:blue;color:#FFF;">返回</div>
						</div>
					</div>
				</div>
			</div>
...
<script type="text/javascript" src="../newFile/js/kkpager.min.js"></script>
 ...
 <script type="text/javascript">
	$(".private-n1 li").eq(2).addClass('open');
	$(function(){
		$("#update").click(function () {
			var name = $("#name").val();
			if(!name) return alert("通知不能为空");
			$.post("../notice/save.do",{name:name},function(data){
				console.log(data)
				if(data.error.code == 1)
				{
					alert("添加成功");
					return window.location.href = '../notice/toList.do';
				}
				else
				{
